...
<body>
    ...
    <section id="header" class="header">
        <a href="#" class="logo"><img src="{{ asset('assets/images/logo-galeri3.png') }}" alt="logo-galeri3.png"></a>
          <nav class="navbar">  
            <a href="/admin/setelah_login">Home</a>
            <a href="/admin/tabel_galeri">Data Foto</a>
            <a href="/admin/tambah_galeri">Tambah Foto</a>
...
<section class="gallery" id="home">
    <h1 class="heading">Foto <span>Terbaru</span></h1>
