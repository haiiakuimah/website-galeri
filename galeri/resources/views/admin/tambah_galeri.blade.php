      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Galeri</h1>
            <br>
            <a class="btn btn-secondary" href="/admin/tabel_galeri" > Tabel Foto </a>
            </br>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <form method="POST" action="{{ route('simpanGaleri') }}"  enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                    <label for="judulFoto">Nama judul</label>
                    <input type="text" class="form-control" id="judulFoto" placeholder="Masukkan Judul Foto" name="judulFoto">
                  </div>
                    <div class="form-group">
                    <label for="deskripsiFoto">Nama deskripsi</label>
                    <input type="text" class="form-control" id="deskripsiFoto" placeholder="Masukkan Deskripsi Foto" name="deskripsiFoto">
                  </div>
                  <div class="form-group">
